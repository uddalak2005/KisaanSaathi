...
useEffect(()=>{
    try{
        ...
        const token = localStorage.getItem('token')
    axios.get(`http://localhost:3000/api/dashboard/${aadharNumber}`,{
        headers:{
            Authorization: `Bearer ${token}`
        }
    }).then((res)=>{
...
if(!graphData){
    ...
    return (
        ...
        <motion.div className='navbar-dash' 
        initial={{y:-100}}
        animate={{y:0}}
        ...
        <motion.div className='logo-dash-img'></motion.div>
            ...
            >
                ...
                <div className='Account-dash' id='optChild' style={{opacity:expanded? '1':'0'}}>Accounts</div>
                <div className='Transactions-dash' id='optChild' style={{opacity:expanded? '1':'0'}}>Transactions</div>
                <div className='Enroll-new' id='optChild' style={{opacity:expanded? '1':'0'}}>Enroll new account</div>
                <div className='Crop_insurance' id='optChild' style={{opacity:expanded? '1':'0'}}>Crop insaurance</div>
                <div className='Banking' id='optChild' style={{opacity:expanded? '1':'0'}}>Banking</div>
            ...
            transition={{delay:0.5,duration:0.5}}>
                ...
                <div className='weather-data'>
                    ...
                    <p className='temp'>{weatherData.current ? weatherData.current.temp_c + " C" : "20C"}</p>
                    <p className='obostha'>{weatherData.current ? weatherData.current.condition.text: ""}</p>
                </div>
                ...
                <box-icon name='cloud-lightning' size='100px' color='#00bcff' ></box-icon>
                </div>
                </div>
            ...
            <motion.div className='Dash-main'
